  ...
  return (
    <div>
      ...
      <div className={pos.relcont} style={{padding: '50px 0'}}>
        ...
        <p>Huge thanks to <a href="https://replit.com/@JDOG787" target="_blank" rel="noreferrer">JDOG787</a> for coming up with the name Replverse and <a href="https://replit.com/@19wintersp" target="_blank" rel="noreferrer">19wintersp</a> for the amazing logo.  Also, the hugest shout-out goes to <a href="https://replit.com/@Bookie0" target="_blank" rel="noreferrer">Bookie0</a> for providing the best design feedback, or Replverse would have ended up looking way different (in a not-so-good way).</p>
      </div>
